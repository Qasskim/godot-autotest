...
대상 게임이 아직 개발 중이므로 디버그 빌드를 제공하고 있습니다. APK는 `apk/` 폴더에 포함되어 있습니다.
- 현재 음원도 제작중에 있어 키음 노트는 없는 상태입니다. 만약 필요하시다면 BMS를 컨버팅해서 사용하는 방법이 있습니다. 이 부분은 따로 문의주시면 제공 혹은 변경한 BMS를 제공하겠습니다.
